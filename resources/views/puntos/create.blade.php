...
<form action="/punto" method="post" enctype="multipart/form-data" class="transparent-form">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control shorter-input" id="nombre" name="nombre">
  </div>
  <div class="mb-3">
    <label for="area" class="form-label">Área o SAG</label>
    <input type="text" class="form-control shorter-input" id="area" name="area">
  </div>
  <div class="mb-3">
    <label for="puntos" class="form-label">Agrega tus puntos</label>
